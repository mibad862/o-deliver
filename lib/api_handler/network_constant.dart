import '../const/app_config_constants.dart';
...
class NetworkConstantsUtil {
  ...
  static String register = 'driver/register';
  static String verifyOtp = 'driver/verify-otp';
  static String forgetPassword = 'driver/password/email';
  static String resetPassword = 'driver/password/reset';
  static String fetchCities = 'driver/fetch_cities';
